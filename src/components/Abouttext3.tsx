    ...
    <div className="relative flex items-center justify-center h-auto w-full rounded-xl group hover:bg-gradient-to-l from-gray-200 to-custom-color">
      ...
      <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        ...
        <p className="font-name pb-0 pt-2 text-white text-center">
          ...
          and inclusive space for worship, reflection, and community. This
          beautiful chapel features stunning architecture, serene gardens, and a
          variety of spiritual resources, making it the perfect spot for
          students to connect with their faith, find solace, and grow
          spiritually.
        </p>
      </div>
    </div>
